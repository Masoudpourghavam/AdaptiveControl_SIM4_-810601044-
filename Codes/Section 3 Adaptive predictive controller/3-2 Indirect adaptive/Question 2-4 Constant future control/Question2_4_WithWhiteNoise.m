...
% Question 3-2 Indirect adaptive const. future control with white noise
...
noise_variance = 0.01; % Adjust the noise level as desired
...
for k=1:N
    ...
    y_out(k,1)=phi_y*[a1;a0]+phi_u*[b1_prime;b0_prime] + noise(k); % Add white noise
